...
enum Page {
  ...
  PERSONAL_NOTE = 'notes/personal-note/:uuid',
  PERSONAL_NOTE_FOLDER = 'notes/personal-note-folder/:uuid',
  TEAM_NOTE = 'notes/team-note/:uuid',
  TEAM_NOTE_FOLDER = 'notes/team-note-folder/:uuid',
