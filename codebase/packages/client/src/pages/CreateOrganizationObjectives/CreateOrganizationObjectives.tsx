...
const formInputs = [
  {
    id: 0,
    name: 'Strategic driver 1',
    label: 'Strategic driver 1 label',
    placeholder: 'Enter title for this Strategic driver',
    value: '',
  },
  {
    id: 1,
    name: 'Strategic driver 2',
    label: 'Strategic driver 2 label',
    placeholder: 'Enter title for this Strategic driver',
    value: '',
  },
  {
    id: 2,
    name: 'Strategic driver 3',
    label: 'Strategic driver 3 label',
    placeholder: 'Enter title for this Strategic driver',
    value: '',
  },
  {
    id: 3,
    name: 'Strategic driver 4',
    label: 'Strategic driver 4 label',
    placeholder: 'Enter title for this Strategic driver',
    value: '',
  },
  {
    id: 4,
    name: 'Strategic driver 5',
    label: 'Strategic driver 5 label',
    placeholder: 'Enter title for this Strategic driver',
    value: '',
  },
  {
    id: 5,
    name: 'Strategic driver 6',
    label: 'Strategic driver 6 label',
    placeholder: 'Enter title for this Strategic driver',
    value: '',
  },
];
