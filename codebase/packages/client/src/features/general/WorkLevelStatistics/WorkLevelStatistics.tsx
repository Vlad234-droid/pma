...
import { downloadCsvFile, getTableTitles } from './utils';
import { getAdditionalFields } from './config';

export const WORK_LEVEL_CONTENT_WRAPPER = 'work-level-content-wraper';

const WorkLevelStatistics: FC<{ toggleFullView: Dispatch<SetStateAction<boolean>>; isFullView: boolean }> = ({
  toggleFullView,
  isFullView,
}) => {
...
export default WorkLevelStatistics;
