...
import PersonalNoteForm, { FORM_WRAPPER } from './PersonalNoteFolderForm';
...
describe('PersonalNote feature', () => {
  ...
  it('it should submit form', async () => {
    ...
    const folderInput = getByTestId('input-title');

    await waitFor(() => {
      fireEvent.change(folderInput, { target: { value: 'mocked_value' } });
    });
