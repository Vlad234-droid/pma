  ...
  return (
    <div className={css(WrapperInfo)}>
      <h2 className={css(Title)}>
        Giving feedback helps us to make sure we`re all contributing our best, whether that`s celebrating what`s gone
        well or letting someone know when something could be better.
      </h2>
      ...
      <ol className={css(ordered_list)}>
        <li>
          ...
          positive place. This means they`ll be more likely to listen and reflect on what you`ve shared. An example of
          this would be starting your feedback with something like &quot;I`m sharing this feedback with you so we can
          work better together&quot;.
        </li>
        <li>
          Describe the situation. It`s important to be specific about the time, place, and situation you want to give
          feedback on. Being specific helps provide context for the receiver and ensures your feedback is clear. An
          example of this could be &quot;on Monday when we were working on the customer service desk&quot; or &quot;in
          last week`s team meeting&quot;.
          <li>
            Give great examples. Describe what you observed, assumptions aren`t helpful. For example, &quot;I noticed
            you`ve been late twice this week&quot; is more helpful than &quot;you`re never on time&quot;.
          </li>
          <li>
            Explain the impact. Sharing the impact your examples had gives the receiver an opportunity to reflect and
            think about specific actions they could take going forward. An example of impact &quotthis meant the
