...
export interface ConfigEntryResponse {
   ...
   * @memberof ConfigEntryResponse
   */
  children?: Array<ConfigEntryResponse>;
}
/**
 *
 * @export
...
export const CepApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    processColleagueChangeEvent: async (
      eventRequestColleagueChangeEventPayload: EventRequestColleagueChangeEventPayload,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'eventRequestColleagueChangeEventPayload' is not null or undefined
      assertParamExists(
        'processColleagueChangeEvent',
        'eventRequestColleagueChangeEventPayload',
        eventRequestColleagueChangeEventPayload,
      );
...
export const CepApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async processColleagueChangeEvent(
      eventRequestColleagueChangeEventPayload: EventRequestColleagueChangeEventPayload,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.processColleagueChangeEvent(
        eventRequestColleagueChangeEventPayload,
        options,
      );
...
export const CepApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    processColleagueChangeEvent(
      ...
      return localVarFp
        .processColleagueChangeEvent(eventRequestColleagueChangeEventPayload, options)
...
export class CepApi extends BaseAPI {
   ...
   * @memberof CepApi
   */
  public processColleagueChangeEvent(
    requestParameters: CepApiProcessColleagueChangeEventRequest,
    options?: AxiosRequestConfig,
  ) {
    return CepApiFp(this.configuration)
      .processColleagueChangeEvent(requestParameters.eventRequestColleagueChangeEventPayload, options)
...
export const ColleaguesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getSuggestions(
      ...
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListColleagueProfile>> {
...
export class ColleaguesApi extends BaseAPI {
  ...
  public getSuggestions(requestParameters: ColleaguesApiGetSuggestionsRequest, options?: AxiosRequestConfig) {
    return ColleaguesApiFp(this.configuration)
      .getSuggestions(requestParameters.requestQuery, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const ConfigApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    updateDefaultAttributes: async (colleagueUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/config/default/attributes/colleagues/{colleagueUuid}`.replace(
        `{${'colleagueUuid'}}`,
        encodeURIComponent(String(colleagueUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
...
export const ConfigApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async updateDefaultAttributes(
      colleagueUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseObject>> {
...
export class ConfigApi extends BaseAPI {
   ...
   * @memberof ConfigApi
   */
  public updateDefaultAttributes(
    requestParameters: ConfigApiUpdateDefaultAttributesRequest,
    options?: AxiosRequestConfig,
  ) {
    return ConfigApiFp(this.configuration)
      .updateDefaultAttributes(requestParameters.colleagueUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const ConfigEntryApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    delete4: async (entryUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'entryUuid' is not null or undefined
      assertParamExists('delete4', 'entryUuid', entryUuid);
      const localVarPath = `/config-entries/{entryUuid}`.replace(
        `{${'entryUuid'}}`,
        encodeURIComponent(String(entryUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
     ...
     * @throws {RequiredError}
     */
    findColleaguesByCompositeKey: async (
      compositeKey: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getPublishedEntryConfigStructure: async (
      entryUuid: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'entryUuid' is not null or undefined
     ...
     * @throws {RequiredError}
     */
    getPublishedEntryConfigStructureByCompositeKey: async (
      compositeKey: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'compositeKey' is not null or undefined
     ...
     * @throws {RequiredError}
     */
    getUnpublishedEntryConfigStructure: async (
      entryUuid: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'entryUuid' is not null or undefined
      assertParamExists('getUnpublishedEntryConfigStructure', 'entryUuid', entryUuid);
      const localVarPath = `/config-entries/{entryUuid}/unpublished`.replace(
        `{${'entryUuid'}}`,
        encodeURIComponent(String(entryUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    publishEntryConfigStructure: async (entryUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/config-entries/{entryUuid}/publish`.replace(
        `{${'entryUuid'}}`,
        encodeURIComponent(String(entryUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    unpublishEntryConfigStructure: async (
      entryUuid: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'entryUuid' is not null or undefined
...
export const ConfigEntryApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async delete4(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.delete4(entryUuid, options);
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async findColleaguesByCompositeKey(
      compositeKey: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListColleagueEntity>> {
     ...
     * @throws {RequiredError}
     */
    async getPublishedEntryConfigStructure(
      entryUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseConfigEntryResponse>> {
     ...
     * @throws {RequiredError}
     */
    async getPublishedEntryConfigStructureByCompositeKey(
      compositeKey: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListConfigEntryResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPublishedEntryConfigStructureByCompositeKey(
        compositeKey,
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
     ...
     * @throws {RequiredError}
     */
    async getUnpublishedEntryConfigStructure(
      entryUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseConfigEntryResponse>> {
     ...
     * @throws {RequiredError}
     */
    async publishEntryConfigStructure(
      entryUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseObject>> {
     ...
     * @throws {RequiredError}
     */
    async unpublishEntryConfigStructure(
      entryUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseObject>> {
 ...
 * @export
 */
export const ConfigEntryApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    delete4(entryUuid: string, options?: any): AxiosPromise<RestResponseObject> {
      return localVarFp.delete4(entryUuid, options).then((request) => request(axios, basePath));
    },
    /**
     *
     * @summary Get colleagues by composite key
    ...
    getPublishedEntryConfigStructure(entryUuid: string, options?: any): AxiosPromise<RestResponseConfigEntryResponse> {
      return localVarFp
        .getPublishedEntryConfigStructure(entryUuid, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getPublishedEntryConfigStructureByCompositeKey(
      compositeKey: string,
      options?: any,
    ): AxiosPromise<RestResponseListConfigEntryResponse> {
      return localVarFp
        .getPublishedEntryConfigStructureByCompositeKey(compositeKey, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getUnpublishedEntryConfigStructure(
      entryUuid: string,
      options?: any,
    ): AxiosPromise<RestResponseConfigEntryResponse> {
      return localVarFp
        .getUnpublishedEntryConfigStructure(entryUuid, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
/**
 * Request parameters for delete4 operation in ConfigEntryApi.
 * @export
 * @interface ConfigEntryApiDelete4Request
 */
export interface ConfigEntryApiDelete4Request {
  /**
   *
   * @type {string}
   * @memberof ConfigEntryApiDelete4
   */
...
export class ConfigEntryApi extends BaseAPI {
  ...
  public create4(requestParameters: ConfigEntryApiCreate4Request, options?: AxiosRequestConfig) {
    return ConfigEntryApiFp(this.configuration)
      .create4(requestParameters.configEntry, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   *
   * @summary Delete config entry
   * @param {ConfigEntryApiDelete4Request} requestParameters Request parameters.
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof ConfigEntryApi
   */
  public delete4(requestParameters: ConfigEntryApiDelete4Request, options?: AxiosRequestConfig) {
    return ConfigEntryApiFp(this.configuration)
      .delete4(requestParameters.entryUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ConfigEntryApi
   */
  public findColleaguesByCompositeKey(
    requestParameters: ConfigEntryApiFindColleaguesByCompositeKeyRequest,
    options?: AxiosRequestConfig,
  ) {
    return ConfigEntryApiFp(this.configuration)
      .findColleaguesByCompositeKey(requestParameters.compositeKey, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ConfigEntryApi
   */
  public getPublishedEntryConfigStructure(
    requestParameters: ConfigEntryApiGetPublishedEntryConfigStructureRequest,
    options?: AxiosRequestConfig,
  ) {
    return ConfigEntryApiFp(this.configuration)
      .getPublishedEntryConfigStructure(requestParameters.entryUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ConfigEntryApi
   */
  public getPublishedEntryConfigStructureByCompositeKey(
    requestParameters: ConfigEntryApiGetPublishedEntryConfigStructureByCompositeKeyRequest,
    options?: AxiosRequestConfig,
  ) {
    return ConfigEntryApiFp(this.configuration)
      .getPublishedEntryConfigStructureByCompositeKey(requestParameters.compositeKey, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getUnpublished(requestParameters: ConfigEntryApiGetUnpublishedRequest, options?: AxiosRequestConfig) {
    return ConfigEntryApiFp(this.configuration)
      .getUnpublished(requestParameters.compositeKey, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ConfigEntryApi
   */
  public getUnpublishedEntryConfigStructure(
    requestParameters: ConfigEntryApiGetUnpublishedEntryConfigStructureRequest,
    options?: AxiosRequestConfig,
  ) {
    return ConfigEntryApiFp(this.configuration)
      .getUnpublishedEntryConfigStructure(requestParameters.entryUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ConfigEntryApi
   */
  public publishEntryConfigStructure(
    requestParameters: ConfigEntryApiPublishEntryConfigStructureRequest,
    options?: AxiosRequestConfig,
  ) {
    return ConfigEntryApiFp(this.configuration)
      .publishEntryConfigStructure(requestParameters.entryUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ConfigEntryApi
   */
  public unpublishEntryConfigStructure(
    requestParameters: ConfigEntryApiUnpublishEntryConfigStructureRequest,
    options?: AxiosRequestConfig,
  ) {
    return ConfigEntryApiFp(this.configuration)
      .unpublishEntryConfigStructure(requestParameters.entryUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public update4(requestParameters: ConfigEntryApiUpdate4Request, options?: AxiosRequestConfig) {
    return ConfigEntryApiFp(this.configuration)
      .update4(requestParameters.entryUuid, requestParameters.configEntry, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const DeploymentEndpointApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    undeploy: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/deployments/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    undeployProcess: async (processName: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/processes/{processName}`.replace(
        `{${'processName'}}`,
...
export const DeploymentEndpointApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async deploy1(
      ...
      files?: Array<any>,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseDeploymentInfo>> {
    ...
    async deployments(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListDeploymentInfo>> {
    ...
    async processes(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListString>> {
    ...
    async undeployProcess(
      processName: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseString>> {
 ...
 * @export
 */
export const DeploymentEndpointApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
/**
 * Request parameters for deploy1 operation in DeploymentEndpointApi.
 * @export
 * @interface DeploymentEndpointApiDeploy1Request
 */
export interface DeploymentEndpointApiDeploy1Request {
  /**
   *
   * @type {string}
   * @memberof DeploymentEndpointApiDeploy1
   */
...
export class DeploymentEndpointApi extends BaseAPI {
  /**
   *
   * @param {DeploymentEndpointApiDeploy1Request} requestParameters Request parameters.
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof DeploymentEndpointApi
   */
  public deploy1(requestParameters: DeploymentEndpointApiDeploy1Request = {}, options?: AxiosRequestConfig) {
    return DeploymentEndpointApiFp(this.configuration)
      .deploy1(requestParameters.deploymentName, requestParameters.files, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public deployProcess(requestParameters: DeploymentEndpointApiDeployProcessRequest, options?: AxiosRequestConfig) {
    return DeploymentEndpointApiFp(this.configuration)
      .deployProcess(requestParameters.body, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public undeploy(requestParameters: DeploymentEndpointApiUndeployRequest, options?: AxiosRequestConfig) {
    return DeploymentEndpointApiFp(this.configuration)
      .undeploy(requestParameters.id, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public undeployByName(requestParameters: DeploymentEndpointApiUndeployByNameRequest, options?: AxiosRequestConfig) {
    return DeploymentEndpointApiFp(this.configuration)
      .undeployByName(requestParameters.name, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public undeployProcess(requestParameters: DeploymentEndpointApiUndeployProcessRequest, options?: AxiosRequestConfig) {
    return DeploymentEndpointApiFp(this.configuration)
      .undeployProcess(requestParameters.processName, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const DiagnosticApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getOverallHealthCheck(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OverallHealth>> {
...
export class DiagnosticApi extends BaseAPI {
  ...
  public getHc(options?: AxiosRequestConfig) {
    return DiagnosticApiFp(this.configuration)
      .getHc(options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const DictionariesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    findAll: async (dictionary: string, code?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/dictionaries/{dictionary}`.replace(
        `{${'dictionary'}}`,
        encodeURIComponent(String(dictionary)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
...
export const DictionariesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async findAll(
      ...
      code?: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListGeneralDictionaryItem>> {
    ...
    async read(
      ...
      id: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseGeneralDictionaryItem>> {
...
export class DictionariesApi extends BaseAPI {
  ...
  public findAll(requestParameters: DictionariesApiFindAllRequest, options?: AxiosRequestConfig) {
    return DictionariesApiFp(this.configuration)
      .findAll(requestParameters.dictionary, requestParameters.code, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public read(requestParameters: DictionariesApiReadRequest, options?: AxiosRequestConfig) {
    return DictionariesApiFp(this.configuration)
      .read(requestParameters.dictionary, requestParameters.id, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const FeedbackApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getFeedback: async (uuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/feedbacks/{uuid}`.replace(`{${'uuid'}}`, encodeURIComponent(String(uuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    markAsRead: async (uuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/feedbacks/{uuid}/read`.replace(`{${'uuid'}}`, encodeURIComponent(String(uuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const FeedbackApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createFeedbacks(
      ...
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListFeedback>> {
    ...
    async getFeedback(
      uuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseFeedback>> {
    ...
    async markAsRead(
      uuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseVoid>> {
...
export class FeedbackApi extends BaseAPI {
  ...
  public createFeedbacks(requestParameters: FeedbackApiCreateFeedbacksRequest, options?: AxiosRequestConfig) {
    return FeedbackApiFp(this.configuration)
      .createFeedbacks(requestParameters.feedback, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getAllFeedbacks(requestParameters: FeedbackApiGetAllFeedbacksRequest, options?: AxiosRequestConfig) {
    return FeedbackApiFp(this.configuration)
      .getAllFeedbacks(requestParameters.requestQuery, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getFeedback(requestParameters: FeedbackApiGetFeedbackRequest, options?: AxiosRequestConfig) {
    return FeedbackApiFp(this.configuration)
      .getFeedback(requestParameters.uuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public markAsRead(requestParameters: FeedbackApiMarkAsReadRequest, options?: AxiosRequestConfig) {
    return FeedbackApiFp(this.configuration)
      .markAsRead(requestParameters.uuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public updateFeedback(requestParameters: FeedbackApiUpdateFeedbackRequest, options?: AxiosRequestConfig) {
    return FeedbackApiFp(this.configuration)
      .updateFeedback(requestParameters.uuid, requestParameters.feedback, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const FileApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    download: async (fileUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/files/{fileUuid}/download`.replace(
        `{${'fileUuid'}}`,
        encodeURIComponent(String(fileUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
     ...
     * @throws {RequiredError}
     */
    get: async (fileUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'fileUuid' is not null or undefined
      assertParamExists('get', 'fileUuid', fileUuid);
      const localVarPath = `/files/{fileUuid}`.replace(`{${'fileUuid'}}`, encodeURIComponent(String(fileUuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const FileApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async get(
      fileUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseFile>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.get(fileUuid, options);
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
    /**
     * Get Files information with the latest version applying search, filter and sorting
    ...
    async get2(
      requestQuery: RequestQuery,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListFile>> {
...
export const FileApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    get(fileUuid: string, options?: any): AxiosPromise<RestResponseFile> {
      return localVarFp.get(fileUuid, options).then((request) => request(axios, basePath));
    },
    /**
     * Get Files information with the latest version applying search, filter and sorting
     * @summary Get Files information with the latest version applying search, filter and sorting
...
export class FileApi extends BaseAPI {
  ...
  public download(requestParameters: FileApiDownloadRequest, options?: AxiosRequestConfig) {
    return FileApiFp(this.configuration)
      .download(requestParameters.fileUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public get(requestParameters: FileApiGetRequest, options?: AxiosRequestConfig) {
    return FileApiFp(this.configuration)
      .get(requestParameters.fileUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public get2(requestParameters: FileApiGet2Request, options?: AxiosRequestConfig) {
    return FileApiFp(this.configuration)
      .get2(requestParameters.requestQuery, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public get4(requestParameters: FileApiGet4Request, options?: AxiosRequestConfig) {
    return FileApiFp(this.configuration)
      .get4(requestParameters.path, requestParameters.fileName, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getAllVersions(requestParameters: FileApiGetAllVersionsRequest, options?: AxiosRequestConfig) {
    return FileApiFp(this.configuration)
      .getAllVersions(requestParameters.path, requestParameters.fileName, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public upload(requestParameters: FileApiUploadRequest = {}, options?: AxiosRequestConfig) {
    return FileApiFp(this.configuration)
      .upload(requestParameters.uploadMetadata, requestParameters.files, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const NotesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    delete2: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/notes/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    delete3: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/notes/folders/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
     ...
     * @throws {RequiredError}
     */
    update2: async (id: string, folder: Folder, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists('update2', 'id', id);
      // verify required parameter 'folder' is not null or undefined
      assertParamExists('update2', 'folder', folder);
      const localVarPath = `/notes/folders/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
...
export const NotesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createNote(
      note: Note,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseNote>> {
    ...
    async findByFolder1(
      ...
      ownerId: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListNote>> {
    ...
    async get3(
      ownerId: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListFolder>> {
    ...
    async update2(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.update2(id, folder, options);
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
    /**
     *
...
export const NotesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    delete3(id: string, options?: any): AxiosPromise<RestResponseObject> {
     ...
     * @throws {RequiredError}
     */
    update2(id: string, folder: Folder, options?: any): AxiosPromise<RestResponseObject> {
      return localVarFp.update2(id, folder, options).then((request) => request(axios, basePath));
    },
    /**
     *
     * @summary Update a Note
...
export class NotesApi extends BaseAPI {
  ...
  public createFolder(requestParameters: NotesApiCreateFolderRequest, options?: AxiosRequestConfig) {
    return NotesApiFp(this.configuration)
      .createFolder(requestParameters.folder, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public createNote(requestParameters: NotesApiCreateNoteRequest, options?: AxiosRequestConfig) {
    return NotesApiFp(this.configuration)
      .createNote(requestParameters.note, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public findByFolder1(requestParameters: NotesApiFindByFolder1Request, options?: AxiosRequestConfig) {
    return NotesApiFp(this.configuration)
      .findByFolder1(requestParameters.folderId, requestParameters.ownerId, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public get3(requestParameters: NotesApiGet3Request, options?: AxiosRequestConfig) {
    return NotesApiFp(this.configuration)
      .get3(requestParameters.ownerId, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public update2(requestParameters: NotesApiUpdate2Request, options?: AxiosRequestConfig) {
    return NotesApiFp(this.configuration)
      .update2(requestParameters.id, requestParameters.folder, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public update3(requestParameters: NotesApiUpdate3Request, options?: AxiosRequestConfig) {
    return NotesApiFp(this.configuration)
      .update3(requestParameters.id, requestParameters.note, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const ObjectiveSharingApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    getSharedObjectivesForColleague: async (
      colleagueUuid: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'colleagueUuid' is not null or undefined
      assertParamExists('getSharedObjectivesForColleague', 'colleagueUuid', colleagueUuid);
      const localVarPath = `/colleagues/{colleagueUuid}/review-types/objective/sharing`.replace(
        `{${'colleagueUuid'}}`,
        encodeURIComponent(String(colleagueUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    isColleagueShareObjectives: async (
      cycleUuid: string,
      colleagueUuid: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
...
export const ObjectiveSharingApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getSharedObjectivesForColleague(
      colleagueUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListReview>> {
     ...
     * @throws {RequiredError}
     */
    async isColleagueShareObjectives(
      cycleUuid: string,
      colleagueUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseBoolean>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.isColleagueShareObjectives(
        cycleUuid,
        colleagueUuid,
        options,
      );
     ...
     * @throws {RequiredError}
     */
    async stopSharingObjectives(
      cycleUuid: string,
      colleagueUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseObject>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.stopSharingObjectives(
        cycleUuid,
        colleagueUuid,
        options,
      );
 ...
 * @export
 */
export const ObjectiveSharingApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    getSharedObjectivesForColleague(colleagueUuid: string, options?: any): AxiosPromise<RestResponseListReview> {
      return localVarFp
        .getSharedObjectivesForColleague(colleagueUuid, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    isColleagueShareObjectives(
      cycleUuid: string,
      colleagueUuid: string,
      options?: any,
    ): AxiosPromise<RestResponseBoolean> {
      return localVarFp
        .isColleagueShareObjectives(cycleUuid, colleagueUuid, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    stopSharingObjectives(cycleUuid: string, colleagueUuid: string, options?: any): AxiosPromise<RestResponseObject> {
      return localVarFp
        .stopSharingObjectives(cycleUuid, colleagueUuid, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class ObjectiveSharingApi extends BaseAPI {
   ...
   */
  public getSharedObjectivesForColleague(
    requestParameters: ObjectiveSharingApiGetSharedObjectivesForColleagueRequest,
    options?: AxiosRequestConfig,
  ) {
    return ObjectiveSharingApiFp(this.configuration)
      .getSharedObjectivesForColleague(requestParameters.colleagueUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ObjectiveSharingApi
   */
  public isColleagueShareObjectives(
    requestParameters: ObjectiveSharingApiIsColleagueShareObjectivesRequest,
    options?: AxiosRequestConfig,
  ) {
    return ObjectiveSharingApiFp(this.configuration)
      .isColleagueShareObjectives(requestParameters.cycleUuid, requestParameters.colleagueUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public shareObjectives(requestParameters: ObjectiveSharingApiShareObjectivesRequest, options?: AxiosRequestConfig) {
    return ObjectiveSharingApiFp(this.configuration)
      .shareObjectives(requestParameters.cycleUuid, requestParameters.colleagueUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ObjectiveSharingApi
   */
  public stopSharingObjectives(
    requestParameters: ObjectiveSharingApiStopSharingObjectivesRequest,
    options?: AxiosRequestConfig,
  ) {
    return ObjectiveSharingApiFp(this.configuration)
      .stopSharingObjectives(requestParameters.cycleUuid, requestParameters.colleagueUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const OrgObjectiveApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    createAndPublishOrgObjectives: async (
      orgObjective: Array<OrgObjective>,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
...
export const OrgObjectiveApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createAndPublishOrgObjectives(
      orgObjective: Array<OrgObjective>,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListOrgObjective>> {
    ...
    async getAuditLogReport(
      requestQuery: RequestQuery,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListAuditOrgObjectiveReport>> {
     ...
     * @throws {RequiredError}
     */
    async getPublishedOrgObjectives(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListOrgObjective>> {
 ...
 * @export
 */
export const OrgObjectiveApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createAndPublishOrgObjectives(
      orgObjective: Array<OrgObjective>,
      options?: any,
    ): AxiosPromise<RestResponseListOrgObjective> {
      return localVarFp
        .createAndPublishOrgObjectives(orgObjective, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Organisation objectives created
    ...
    getAuditLogReport(
      requestQuery: RequestQuery,
      options?: any,
    ): AxiosPromise<RestResponseListAuditOrgObjectiveReport> {
...
export class OrgObjectiveApi extends BaseAPI {
   ...
   */
  public createAndPublishOrgObjectives(
    requestParameters: OrgObjectiveApiCreateAndPublishOrgObjectivesRequest,
    options?: AxiosRequestConfig,
  ) {
    return OrgObjectiveApiFp(this.configuration)
      .createAndPublishOrgObjectives(requestParameters.orgObjective, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof OrgObjectiveApi
   */
  public createOrgObjectives(
    requestParameters: OrgObjectiveApiCreateOrgObjectivesRequest,
    options?: AxiosRequestConfig,
  ) {
    return OrgObjectiveApiFp(this.configuration)
      .createOrgObjectives(requestParameters.orgObjective, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getAuditLogReport(requestParameters: OrgObjectiveApiGetAuditLogReportRequest, options?: AxiosRequestConfig) {
    return OrgObjectiveApiFp(this.configuration)
      .getAuditLogReport(requestParameters.requestQuery, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getPublishedOrgObjectives(options?: AxiosRequestConfig) {
    return OrgObjectiveApiFp(this.configuration)
      .getPublishedOrgObjectives(options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const OrganisationDictionaryApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    delete1: async (code: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'code' is not null or undefined
      assertParamExists('delete1', 'code', code);
      const localVarPath = `/organisations/{code}`.replace(`{${'code'}}`, encodeURIComponent(String(code)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    update5: async (
      ...
      // verify required parameter 'code' is not null or undefined
      assertParamExists('update5', 'code', code);
      // verify required parameter 'organisationDictionary' is not null or undefined
      assertParamExists('update5', 'organisationDictionary', organisationDictionary);
      const localVarPath = `/organisations/{code}`.replace(`{${'code'}}`, encodeURIComponent(String(code)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
...
export const OrganisationDictionaryApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async create3(
      organisationDictionary: OrganisationDictionary,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseOrganisationDictionary>> {
     ...
     * @throws {RequiredError}
     */
    async findAllOrganisationDictionaries(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListOrganisationDictionary>> {
     ...
     * @throws {RequiredError}
     */
    async findOrganisationDictionary(
      code: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseOrganisationDictionary>> {
    ...
    async update5(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.update5(code, organisationDictionary, options);
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
  };
};
 ...
 * @export
 */
export const OrganisationDictionaryApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    create3(
      organisationDictionary: OrganisationDictionary,
      options?: any,
    ): AxiosPromise<RestResponseOrganisationDictionary> {
     ...
     * @throws {RequiredError}
     */
    delete1(code: string, options?: any): AxiosPromise<RestResponseObject> {
    ...
    update5(
      ...
      organisationDictionary: OrganisationDictionary,
      options?: any,
    ): AxiosPromise<RestResponseObject> {
      return localVarFp.update5(code, organisationDictionary, options).then((request) => request(axios, basePath));
    },
  };
};
...
/**
 * Request parameters for delete1 operation in OrganisationDictionaryApi.
 * @export
 * @interface OrganisationDictionaryApiDelete1Request
 */
export interface OrganisationDictionaryApiDelete1Request {
  /**
   *
   * @type {string}
   * @memberof OrganisationDictionaryApiDelete1
   */
  readonly code: string;
}
...
/**
 * Request parameters for update5 operation in OrganisationDictionaryApi.
 * @export
 * @interface OrganisationDictionaryApiUpdate5Request
 */
export interface OrganisationDictionaryApiUpdate5Request {
  /**
   *
   * @type {string}
   * @memberof OrganisationDictionaryApiUpdate5
   */
  readonly code: string;
...
export class OrganisationDictionaryApi extends BaseAPI {
  ...
  public create3(requestParameters: OrganisationDictionaryApiCreate3Request, options?: AxiosRequestConfig) {
    return OrganisationDictionaryApiFp(this.configuration)
      .create3(requestParameters.organisationDictionary, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   *
   * @summary Delete organisation dictionary
   * @param {OrganisationDictionaryApiDelete1Request} requestParameters Request parameters.
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof OrganisationDictionaryApi
   */
  public delete1(requestParameters: OrganisationDictionaryApiDelete1Request, options?: AxiosRequestConfig) {
    return OrganisationDictionaryApiFp(this.configuration)
      .delete1(requestParameters.code, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public findAllOrganisationDictionaries(options?: AxiosRequestConfig) {
    return OrganisationDictionaryApiFp(this.configuration)
      .findAllOrganisationDictionaries(options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof OrganisationDictionaryApi
   */
  public findOrganisationDictionary(
    requestParameters: OrganisationDictionaryApiFindOrganisationDictionaryRequest,
    options?: AxiosRequestConfig,
  ) {
    return OrganisationDictionaryApiFp(this.configuration)
      .findOrganisationDictionary(requestParameters.code, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   *
   * @summary Update organisation dictionary
   * @param {OrganisationDictionaryApiUpdate5Request} requestParameters Request parameters.
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof OrganisationDictionaryApi
   */
  public update5(requestParameters: OrganisationDictionaryApiUpdate5Request, options?: AxiosRequestConfig) {
    return OrganisationDictionaryApiFp(this.configuration)
      .update5(requestParameters.code, requestParameters.organisationDictionary, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const PdpApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @summary Delete existing PDP Goals from a Plan by its uuids
     * @param {Array<string>} requestBody
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    deleteGoals: async (requestBody: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'requestBody' is not null or undefined
      assertParamExists('deleteGoals', 'requestBody', requestBody);
      const localVarPath = `/pdp/goals/delete`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    getGoal: async (goalUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/pdp/goals/{goalUuid}`.replace(`{${'goalUuid'}}`, encodeURIComponent(String(goalUuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    getGoal1: async (number: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/pdp/goals/numbers/{number}`.replace(`{${'number'}}`, encodeURIComponent(String(number)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
     ...
     * @throws {RequiredError}
     */
    update: async (pDPGoal: Array<PDPGoal>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'pDPGoal' is not null or undefined
      assertParamExists('update', 'pDPGoal', pDPGoal);
      const localVarPath = `/pdp/goals`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
...
export const PdpApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     */
    async create2(
      pDPGoal: Array<PDPGoal>,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListPDPGoal>> {
    ...
    async deleteGoals(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteGoals(requestBody, options);
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
    /**
     *
    ...
    async getGoal(
      goalUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponsePDPResponse>> {
    ...
    async update(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.update(pDPGoal, options);
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
  };
};
...
export const PdpApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    deleteGoals(requestBody: Array<string>, options?: any): AxiosPromise<RestResponseVoid> {
      return localVarFp.deleteGoals(requestBody, options).then((request) => request(axios, basePath));
    },
    /**
     *
     * @summary Get a PDP Goal by its uuid
     ...
     * @throws {RequiredError}
     */
    update(pDPGoal: Array<PDPGoal>, options?: any): AxiosPromise<RestResponseListPDPGoal> {
      return localVarFp.update(pDPGoal, options).then((request) => request(axios, basePath));
    },
  };
};
...
/**
 * Request parameters for deleteGoals operation in PdpApi.
 * @export
 * @interface PdpApiDeleteGoalsRequest
 */
export interface PdpApiDeleteGoalsRequest {
  /**
   *
   * @type {Array<string>}
   * @memberof PdpApiDeleteGoals
   */
...
/**
 * Request parameters for update operation in PdpApi.
 * @export
 * @interface PdpApiUpdateRequest
 */
export interface PdpApiUpdateRequest {
  /**
   *
   * @type {Array<PDPGoal>}
   * @memberof PdpApiUpdate
   */
  readonly pDPGoal: Array<PDPGoal>;
}
...
export class PdpApi extends BaseAPI {
  ...
  public create2(requestParameters: PdpApiCreate2Request, options?: AxiosRequestConfig) {
    return PdpApiFp(this.configuration)
      .create2(requestParameters.pDPGoal, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * Delete existing PDP Goal
   * @summary Delete existing PDP Goals from a Plan by its uuids
   * @param {PdpApiDeleteGoalsRequest} requestParameters Request parameters.
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof PdpApi
   */
  public deleteGoals(requestParameters: PdpApiDeleteGoalsRequest, options?: AxiosRequestConfig) {
    return PdpApiFp(this.configuration)
      .deleteGoals(requestParameters.requestBody, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getGoal(requestParameters: PdpApiGetGoalRequest, options?: AxiosRequestConfig) {
    return PdpApiFp(this.configuration)
      .getGoal(requestParameters.goalUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getGoal1(requestParameters: PdpApiGetGoal1Request, options?: AxiosRequestConfig) {
    return PdpApiFp(this.configuration)
      .getGoal1(requestParameters.number, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * PDP updated
   * @summary Update a PDP
   * @param {PdpApiUpdateRequest} requestParameters Request parameters.
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof PdpApi
   */
  public update(requestParameters: PdpApiUpdateRequest, options?: AxiosRequestConfig) {
    return PdpApiFp(this.configuration)
      .update(requestParameters.pDPGoal, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const PerformanceCycleApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    deploy: async (uuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/pm-cycles/{uuid}/deploy`.replace(`{${'uuid'}}`, encodeURIComponent(String(uuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
     ...
     * @throws {RequiredError}
     */
    get1: async (uuid: string, includeForms?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'uuid' is not null or undefined
      assertParamExists('get1', 'uuid', uuid);
      const localVarPath = `/pm-cycles/{uuid}`.replace(`{${'uuid'}}`, encodeURIComponent(String(uuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    getMetadataByColleague: async (
      ...
      const localVarPath = `/colleagues/{colleagueUuid}/metadata`.replace(
        `{${'colleagueUuid'}}`,
        encodeURIComponent(String(colleagueUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getPmCycleMetadata: async (
      ...
      const localVarPath = `/pm-cycles/files/{uuid}/metadata`.replace(`{${'uuid'}}`, encodeURIComponent(String(uuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    start: async (uuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/pm-cycles/{uuid}/start`.replace(`{${'uuid'}}`, encodeURIComponent(String(uuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
     ...
     * @throws {RequiredError}
     */
    update1: async (uuid: string, pMCycle: PMCycle, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'uuid' is not null or undefined
      assertParamExists('update1', 'uuid', uuid);
      // verify required parameter 'pMCycle' is not null or undefined
      assertParamExists('update1', 'pMCycle', pMCycle);
      const localVarPath = `/pm-cycles/{uuid}`.replace(`{${'uuid'}}`, encodeURIComponent(String(uuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
...
export const PerformanceCycleApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async create1(
      pMCycle: PMCycle,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponsePMCycle>> {
    ...
    async deploy(
      uuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseUUID>> {
    ...
    async get1(
      ...
      includeForms?: boolean,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseCompositePMCycleResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.get1(uuid, includeForms, options);
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
    /**
     *
    ...
    async getAll(
      ...
      includeMetadata?: boolean,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListPMCycle>> {
     ...
     * @throws {RequiredError}
     */
    async getMetadataByColleague(
      colleagueUuid: string,
      includeForms?: boolean,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseCompositePMCycleMetadataResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMetadataByColleague(
        colleagueUuid,
        includeForms,
        options,
      );
    ...
    async update1(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.update1(uuid, pMCycle, options);
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
    /**
     *
 ...
 * @export
 */
export const PerformanceCycleApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    get1(uuid: string, includeForms?: boolean, options?: any): AxiosPromise<RestResponseCompositePMCycleResponse> {
      return localVarFp.get1(uuid, includeForms, options).then((request) => request(axios, basePath));
    },
    /**
     *
     * @summary Get all performance cycles
    ...
    getAll(
      ...
      includeMetadata?: boolean,
      options?: any,
    ): AxiosPromise<RestResponseListPMCycle> {
     ...
     * @throws {RequiredError}
     */
    getMetadataByColleague(
      colleagueUuid: string,
      includeForms?: boolean,
      options?: any,
    ): AxiosPromise<RestResponseCompositePMCycleMetadataResponse> {
      return localVarFp
        .getMetadataByColleague(colleagueUuid, includeForms, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    update1(uuid: string, pMCycle: PMCycle, options?: any): AxiosPromise<RestResponsePMCycle> {
      return localVarFp.update1(uuid, pMCycle, options).then((request) => request(axios, basePath));
    },
    /**
     *
     * @summary Update performance cycle status
    ...
    updateStatus(
      ...
      status:
        ...
        | 'TERMINATED',
      options?: any,
    ): AxiosPromise<RestResponsePMCycle> {
...
/**
 * Request parameters for get1 operation in PerformanceCycleApi.
 * @export
 * @interface PerformanceCycleApiGet1Request
 */
export interface PerformanceCycleApiGet1Request {
  /**
   *
   * @type {string}
   * @memberof PerformanceCycleApiGet1
   */
  readonly uuid: string;
...
/**
 * Request parameters for update1 operation in PerformanceCycleApi.
 * @export
 * @interface PerformanceCycleApiUpdate1Request
 */
export interface PerformanceCycleApiUpdate1Request {
  /**
   *
   * @type {string}
   * @memberof PerformanceCycleApiUpdate1
   */
  readonly uuid: string;
...
export class PerformanceCycleApi extends BaseAPI {
  ...
  public create1(requestParameters: PerformanceCycleApiCreate1Request, options?: AxiosRequestConfig) {
    return PerformanceCycleApiFp(this.configuration)
      .create1(requestParameters.pMCycle, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public deploy(requestParameters: PerformanceCycleApiDeployRequest, options?: AxiosRequestConfig) {
    return PerformanceCycleApiFp(this.configuration)
      .deploy(requestParameters.uuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   *
   * @summary Get performance cycle by UUID
   * @param {PerformanceCycleApiGet1Request} requestParameters Request parameters.
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof PerformanceCycleApi
   */
  public get1(requestParameters: PerformanceCycleApiGet1Request, options?: AxiosRequestConfig) {
    return PerformanceCycleApiFp(this.configuration)
      .get1(requestParameters.uuid, requestParameters.includeForms, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getAll(requestParameters: PerformanceCycleApiGetAllRequest, options?: AxiosRequestConfig) {
    return PerformanceCycleApiFp(this.configuration)
      .getAll(requestParameters.requestQuery, requestParameters.includeMetadata, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof PerformanceCycleApi
   */
  public getMetadataByColleague(
    requestParameters: PerformanceCycleApiGetMetadataByColleagueRequest,
    options?: AxiosRequestConfig,
  ) {
    return PerformanceCycleApiFp(this.configuration)
      .getMetadataByColleague(requestParameters.colleagueUuid, requestParameters.includeForms, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof PerformanceCycleApi
   */
  public getPmCycleMetadata(
    requestParameters: PerformanceCycleApiGetPmCycleMetadataRequest,
    options?: AxiosRequestConfig,
  ) {
    return PerformanceCycleApiFp(this.configuration)
      .getPmCycleMetadata(requestParameters.uuid, requestParameters.includeForms, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public publish(requestParameters: PerformanceCycleApiPublishRequest, options?: AxiosRequestConfig) {
    return PerformanceCycleApiFp(this.configuration)
      .publish(requestParameters.pMCycle, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public start(requestParameters: PerformanceCycleApiStartRequest, options?: AxiosRequestConfig) {
    return PerformanceCycleApiFp(this.configuration)
      .start(requestParameters.uuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * Performance cycle edited
   * @summary Updates an existing performance cycle
   * @param {PerformanceCycleApiUpdate1Request} requestParameters Request parameters.
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof PerformanceCycleApi
   */
  public update1(requestParameters: PerformanceCycleApiUpdate1Request, options?: AxiosRequestConfig) {
    return PerformanceCycleApiFp(this.configuration)
      .update1(requestParameters.uuid, requestParameters.pMCycle, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public updateStatus(requestParameters: PerformanceCycleApiUpdateStatusRequest, options?: AxiosRequestConfig) {
    return PerformanceCycleApiFp(this.configuration)
      .updateStatus(requestParameters.uuid, requestParameters.status, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const ProcessesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    runProcessByKey: async (
      ...
      const localVarPath = `/processes/keys/{process-key}`.replace(
        `{${'process-key'}}`,
        encodeURIComponent(String(processKey)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
...
export const ProcessesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getMetadata(
      processKey: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponsePMCycleMetadata>> {
...
export class ProcessesApi extends BaseAPI {
  ...
  public getMetadata(requestParameters: ProcessesApiGetMetadataRequest, options?: AxiosRequestConfig) {
    return ProcessesApiFp(this.configuration)
      .getMetadata(requestParameters.processKey, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public runProcessByKey(requestParameters: ProcessesApiRunProcessByKeyRequest, options?: AxiosRequestConfig) {
    return ProcessesApiFp(this.configuration)
      .runProcessByKey(requestParameters.processKey, requestParameters.params, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const ProfileApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    createProfileAttributes: async (
      ...
      const localVarPath = `/colleagues/{colleagueUuid}/attributes`.replace(
        `{${'colleagueUuid'}}`,
        encodeURIComponent(String(colleagueUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getImportRequest: async (requestUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/colleagues/requests/{requestUuid}`.replace(
        `{${'requestUuid'}}`,
        encodeURIComponent(String(requestUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
    ...
    getImportRequestErrors: async (requestUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/colleagues/requests/{requestUuid}/errors`.replace(
        `{${'requestUuid'}}`,
        encodeURIComponent(String(requestUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getProfileByColleagueUuid: async (
      colleagueUuid: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'colleagueUuid' is not null or undefined
      assertParamExists('getProfileByColleagueUuid', 'colleagueUuid', colleagueUuid);
      const localVarPath = `/colleagues/{colleagueUuid}`.replace(
        `{${'colleagueUuid'}}`,
        encodeURIComponent(String(colleagueUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ProfileApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createProfileAttributes(
      ...
      typedAttribute: Array<TypedAttribute>,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListTypedAttribute>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createProfileAttributes(
        colleagueUuid,
        typedAttribute,
        options,
      );
    ...
    async deleteProfileAttributes(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteProfileAttributes(
        colleagueUuid,
        typedAttribute,
        options,
      );
    ...
    async getImportRequest(
      requestUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseImportRequest>> {
     ...
     * @throws {RequiredError}
     */
    async getImportRequestErrors(
      requestUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListImportError>> {
    ...
    async getProfileByColleagueUuid(
      colleagueUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseColleagueProfile>> {
     ...
     * @throws {RequiredError}
     */
    async importColleagues(
      file?: any,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseImportReport>> {
    ...
    async updateProfileAttributes(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateProfileAttributes(
        colleagueUuid,
        typedAttribute,
        options,
      );
...
export const ProfileApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    createProfileAttributes(
      ...
      typedAttribute: Array<TypedAttribute>,
      options?: any,
    ): AxiosPromise<RestResponseListTypedAttribute> {
      return localVarFp
        .createProfileAttributes(colleagueUuid, typedAttribute, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Delete existing profile attributes
    ...
    deleteProfileAttributes(
      ...
      return localVarFp
        .deleteProfileAttributes(colleagueUuid, typedAttribute, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    updateProfileAttributes(
      ...
      return localVarFp
        .updateProfileAttributes(colleagueUuid, typedAttribute, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class ProfileApi extends BaseAPI {
   ...
   * @memberof ProfileApi
   */
  public createProfileAttributes(
    requestParameters: ProfileApiCreateProfileAttributesRequest,
    options?: AxiosRequestConfig,
  ) {
    return ProfileApiFp(this.configuration)
      .createProfileAttributes(requestParameters.colleagueUuid, requestParameters.typedAttribute, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ProfileApi
   */
  public deleteProfileAttributes(
    requestParameters: ProfileApiDeleteProfileAttributesRequest,
    options?: AxiosRequestConfig,
  ) {
    return ProfileApiFp(this.configuration)
      .deleteProfileAttributes(requestParameters.colleagueUuid, requestParameters.typedAttribute, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getImportRequest(requestParameters: ProfileApiGetImportRequestRequest, options?: AxiosRequestConfig) {
    return ProfileApiFp(this.configuration)
      .getImportRequest(requestParameters.requestUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ProfileApi
   */
  public getImportRequestErrors(
    requestParameters: ProfileApiGetImportRequestErrorsRequest,
    options?: AxiosRequestConfig,
  ) {
    return ProfileApiFp(this.configuration)
      .getImportRequestErrors(requestParameters.requestUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ProfileApi
   */
  public getProfileByColleagueUuid(
    requestParameters: ProfileApiGetProfileByColleagueUuidRequest,
    options?: AxiosRequestConfig,
  ) {
    return ProfileApiFp(this.configuration)
      .getProfileByColleagueUuid(requestParameters.colleagueUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public importColleagues(requestParameters: ProfileApiImportColleaguesRequest = {}, options?: AxiosRequestConfig) {
    return ProfileApiFp(this.configuration)
      .importColleagues(requestParameters.file, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ProfileApi
   */
  public updateProfileAttributes(
    requestParameters: ProfileApiUpdateProfileAttributesRequest,
    options?: AxiosRequestConfig,
  ) {
    return ProfileApiFp(this.configuration)
      .updateProfileAttributes(requestParameters.colleagueUuid, requestParameters.typedAttribute, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const RatingApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async overall(
      ...
      howRating: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseMapStringString>> {
...
export class RatingApi extends BaseAPI {
  ...
  public overall(requestParameters: RatingApiOverallRequest, options?: AxiosRequestConfig) {
    return RatingApiFp(this.configuration)
      .overall(requestParameters.whatRating, requestParameters.howRating, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const ReportApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    getLinkedObjectivesReportData: async (
      requestQuery: RequestQuery,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'requestQuery' is not null or undefined
     ...
     * @throws {RequiredError}
     */
    getLinkedObjectivesReportFile: async (
      requestQuery: RequestQuery,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'requestQuery' is not null or undefined
...
export const ReportApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getLinkedObjectivesReportData(
      requestQuery: RequestQuery,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseReport>> {
     ...
     * @throws {RequiredError}
     */
    async getLinkedObjectivesReportFile(
      requestQuery: RequestQuery,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
...
export const ReportApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    getLinkedObjectivesReportData(requestQuery: RequestQuery, options?: any): AxiosPromise<RestResponseReport> {
      return localVarFp
        .getLinkedObjectivesReportData(requestQuery, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getLinkedObjectivesReportFile(requestQuery: RequestQuery, options?: any): AxiosPromise<any> {
      return localVarFp
        .getLinkedObjectivesReportFile(requestQuery, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class ReportApi extends BaseAPI {
   ...
   * @memberof ReportApi
   */
  public getLinkedObjectivesReportData(
    requestParameters: ReportApiGetLinkedObjectivesReportDataRequest,
    options?: AxiosRequestConfig,
  ) {
    return ReportApiFp(this.configuration)
      .getLinkedObjectivesReportData(requestParameters.requestQuery, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ReportApi
   */
  public getLinkedObjectivesReportFile(
    requestParameters: ReportApiGetLinkedObjectivesReportFileRequest,
    options?: AxiosRequestConfig,
  ) {
    return ReportApiFp(this.configuration)
      .getLinkedObjectivesReportFile(requestParameters.requestQuery, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const ReviewApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getFullTeamView: async (managerUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/managers/{managerUuid}/full-team-reviews`.replace(
        `{${'managerUuid'}}`,
        encodeURIComponent(String(managerUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
    ...
    getReviewByUuid: async (uuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/reviews/{uuid}`.replace(`{${'uuid'}}`, encodeURIComponent(String(uuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
     ...
     * @throws {RequiredError}
     */
    getReviewsFilesByColleague: async (
      colleagueUuid: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'colleagueUuid' is not null or undefined
      assertParamExists('getReviewsFilesByColleague', 'colleagueUuid', colleagueUuid);
      const localVarPath = `/colleagues/{colleagueUuid}/reviews/files`.replace(
        `{${'colleagueUuid'}}`,
        encodeURIComponent(String(colleagueUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getTeamView: async (managerUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/managers/{managerUuid}/reviews`.replace(
        `{${'managerUuid'}}`,
        encodeURIComponent(String(managerUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getTimelineByColleague: async (colleagueUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/colleagues/{colleagueUuid}/timeline`.replace(
        `{${'colleagueUuid'}}`,
        encodeURIComponent(String(colleagueUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    updateReviewsStatus: async (
      ...
      status:
        ...
        | 'NOT_STARTED'
        | 'NOT_CREATED',
      updateReviewsStatusRequest: UpdateReviewsStatusRequest,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'colleagueUuid' is not null or undefined
...
export const ReviewApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createReview(
      ...
      review: Review,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseReview>> {
     ...
     * @throws {RequiredError}
     */
    async getFullTeamView(
      managerUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListColleagueView>> {
     ...
     * @throws {RequiredError}
     */
    async getReviewsByColleague(
      colleagueUuid: string,
      cycleUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListReview>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getReviewsByColleague(
        colleagueUuid,
        cycleUuid,
        options,
      );
     ...
     * @throws {RequiredError}
     */
    async getReviewsFilesByColleague(
      colleagueUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListFile>> {
     ...
     * @throws {RequiredError}
     */
    async getTimelineByColleague(
      colleagueUuid: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListTimelinePoint>> {
    ...
    async updateReviews(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateReviews(
        colleagueUuid,
        cycleUuid,
        type,
        review,
    ...
    async updateReviewsStatus(
      ...
      updateReviewsStatusRequest: UpdateReviewsStatusRequest,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponsePMTimelinePointStatus>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateReviewsStatus(
        colleagueUuid,
        cycleUuid,
        type,
        status,
...
export const ReviewApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    createReview(
      ...
      review: Review,
      options?: any,
    ): AxiosPromise<RestResponseReview> {
      return localVarFp
        .createReview(colleagueUuid, cycleUuid, type, number, review, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Delete existing review
    ...
    deleteReview(
      ...
      number: number,
      options?: any,
    ): AxiosPromise<RestResponseVoid> {
      return localVarFp
        .deleteReview(colleagueUuid, cycleUuid, type, number, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getReview(
      ...
      return localVarFp
        .getReview(colleagueUuid, cycleUuid, type, number, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getReviews(
      ...
      type: 'OBJECTIVE' | 'MYR' | 'EYR',
      options?: any,
    ): AxiosPromise<RestResponseListReview> {
     ...
     * @throws {RequiredError}
     */
    getReviewsByColleague(
      colleagueUuid: string,
      cycleUuid: string,
      options?: any,
    ): AxiosPromise<RestResponseListReview> {
      return localVarFp
        .getReviewsByColleague(colleagueUuid, cycleUuid, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    updateReview(
      ...
      return localVarFp
        .updateReview(colleagueUuid, cycleUuid, type, number, review, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Update list of reviews
    ...
    updateReviews(
      ...
      return localVarFp
        .updateReviews(colleagueUuid, cycleUuid, type, review, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Update status of existing reviews
    ...
    updateReviewsStatus(
      ...
      updateReviewsStatusRequest: UpdateReviewsStatusRequest,
      options?: any,
    ): AxiosPromise<RestResponsePMTimelinePointStatus> {
      return localVarFp
        .updateReviewsStatus(colleagueUuid, cycleUuid, type, status, updateReviewsStatusRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class ReviewApi extends BaseAPI {
  ...
  public createReview(requestParameters: ReviewApiCreateReviewRequest, options?: AxiosRequestConfig) {
    return ReviewApiFp(this.configuration)
      .createReview(
        requestParameters.colleagueUuid,
        requestParameters.cycleUuid,
        requestParameters.type,
        requestParameters.number,
        requestParameters.review,
        options,
      )
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getFullTeamView(requestParameters: ReviewApiGetFullTeamViewRequest, options?: AxiosRequestConfig) {
    return ReviewApiFp(this.configuration)
      .getFullTeamView(requestParameters.managerUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getReviewByUuid(requestParameters: ReviewApiGetReviewByUuidRequest, options?: AxiosRequestConfig) {
    return ReviewApiFp(this.configuration)
      .getReviewByUuid(requestParameters.uuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getReviews(requestParameters: ReviewApiGetReviewsRequest, options?: AxiosRequestConfig) {
    return ReviewApiFp(this.configuration)
      .getReviews(requestParameters.colleagueUuid, requestParameters.cycleUuid, requestParameters.type, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getReviewsByColleague(requestParameters: ReviewApiGetReviewsByColleagueRequest, options?: AxiosRequestConfig) {
    return ReviewApiFp(this.configuration)
      .getReviewsByColleague(requestParameters.colleagueUuid, requestParameters.cycleUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ReviewApi
   */
  public getReviewsFilesByColleague(
    requestParameters: ReviewApiGetReviewsFilesByColleagueRequest,
    options?: AxiosRequestConfig,
  ) {
    return ReviewApiFp(this.configuration)
      .getReviewsFilesByColleague(requestParameters.colleagueUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getTeamView(requestParameters: ReviewApiGetTeamViewRequest, options?: AxiosRequestConfig) {
    return ReviewApiFp(this.configuration)
      .getTeamView(requestParameters.managerUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof ReviewApi
   */
  public getTimelineByColleague(
    requestParameters: ReviewApiGetTimelineByColleagueRequest,
    options?: AxiosRequestConfig,
  ) {
    return ReviewApiFp(this.configuration)
      .getTimelineByColleague(requestParameters.colleagueUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public updateReviewsStatus(requestParameters: ReviewApiUpdateReviewsStatusRequest, options?: AxiosRequestConfig) {
    return ReviewApiFp(this.configuration)
      .updateReviewsStatus(
        ...
        requestParameters.updateReviewsStatusRequest,
        options,
      )
      .then((request) => request(this.axios, this.basePath));
  }
 ...
 * @export
 */
export const SpringRestEventListenerApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class SpringRestEventListenerApi extends BaseAPI {
  ...
  public handle(requestParameters: SpringRestEventListenerApiHandleRequest, options?: AxiosRequestConfig) {
    return SpringRestEventListenerApiFp(this.configuration)
      .handle(requestParameters.event, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const TipApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    _delete: async (uuid: string, withHistory?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/tips/{uuid}`.replace(`{${'uuid'}}`, encodeURIComponent(String(uuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    publish1: async (uuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/tips/{uuid}/publish`.replace(`{${'uuid'}}`, encodeURIComponent(String(uuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
    ...
    readHistory: async (uuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/tips/{uuid}/history`.replace(`{${'uuid'}}`, encodeURIComponent(String(uuid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const TipApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async create(
      tip: Tip,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseTip>> {
    ...
    async read1(
      requestQuery: RequestQuery,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListTip>> {
...
export class TipApi extends BaseAPI {
  ...
  public _delete(requestParameters: TipApiDeleteRequest, options?: AxiosRequestConfig) {
    return TipApiFp(this.configuration)
      ._delete(requestParameters.uuid, requestParameters.withHistory, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public create(requestParameters: TipApiCreateRequest, options?: AxiosRequestConfig) {
    return TipApiFp(this.configuration)
      .create(requestParameters.tip, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public publish1(requestParameters: TipApiPublish1Request, options?: AxiosRequestConfig) {
    return TipApiFp(this.configuration)
      .publish1(requestParameters.uuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public read1(requestParameters: TipApiRead1Request, options?: AxiosRequestConfig) {
    return TipApiFp(this.configuration)
      .read1(requestParameters.requestQuery, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public read2(requestParameters: TipApiRead2Request, options?: AxiosRequestConfig) {
    return TipApiFp(this.configuration)
      .read2(requestParameters.uuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public readHistory(requestParameters: TipApiReadHistoryRequest, options?: AxiosRequestConfig) {
    return TipApiFp(this.configuration)
      .readHistory(requestParameters.uuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getUserByColleagueUuid: async (colleagueUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/users/{colleagueUuid}`.replace(
        `{${'colleagueUuid'}}`,
        encodeURIComponent(String(colleagueUuid)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getUserByIamId: async (iamId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/users/iam-ids/{iamId}`.replace(`{${'iamId'}}`, encodeURIComponent(String(iamId)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const UserApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getMe(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseUser>> {
...
export class UserApi extends BaseAPI {
  ...
  public getUserByColleagueUuid(requestParameters: UserApiGetUserByColleagueUuidRequest, options?: AxiosRequestConfig) {
    return UserApiFp(this.configuration)
      .getUserByColleagueUuid(requestParameters.colleagueUuid, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getUserByIamId(requestParameters: UserApiGetUserByIamIdRequest, options?: AxiosRequestConfig) {
    return UserApiFp(this.configuration)
      .getUserByIamId(requestParameters.iamId, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const UserManagementApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async changeAccountStatus(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.changeAccountStatus(
        changeAccountStatusRequest,
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    ...
    async getAccounts(
      ...
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExtendedRestResponseListAccount>> {
    ...
    async getRoles(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestResponseListRole>> {
...
export const UserManagementApiFactory = function (
  ...
  return {
    ...
    changeAccountStatus(
      ...
      return localVarFp
        .changeAccountStatus(changeAccountStatusRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Create an Account
...
export class UserManagementApi extends BaseAPI {
  ...
  public changeAccountStatus(
    requestParameters: UserManagementApiChangeAccountStatusRequest,
    options?: AxiosRequestConfig,
  ) {
    return UserManagementApiFp(this.configuration)
      .changeAccountStatus(requestParameters.changeAccountStatusRequest, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public getAccounts(requestParameters: UserManagementApiGetAccountsRequest = {}, options?: AxiosRequestConfig) {
    return UserManagementApiFp(this.configuration)
      .getAccounts(requestParameters.nextPageToken, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public grantRole(requestParameters: UserManagementApiGrantRoleRequest, options?: AxiosRequestConfig) {
    return UserManagementApiFp(this.configuration)
      .grantRole(requestParameters.roleRequest, options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  public revokeRole(requestParameters: UserManagementApiRevokeRoleRequest, options?: AxiosRequestConfig) {
    return UserManagementApiFp(this.configuration)
      .revokeRole(requestParameters.roleRequest, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
