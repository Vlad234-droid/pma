...
>(obj: TInput, keyConverter: (arg: string) => string): TResult {
  ...
  for (const [k, v] of Object.entries(obj)) {
    ...
    out[keyConverter(k)] = Array.isArray(v)
      ...
      : typeof v === 'object' && Object.prototype.toString.call(v) !== '[object Date]'
      ? convertObject<
          typeof v,
          TResult extends ObjectToCamel<TInput>
...
function toCamel(term: string): string {
...
function toSnake(term: string): string {
  let result = term;
...
function toPascal(term: string): string {
...
export type ObjectToCamel<T extends object | Date | undefined | null> =
  T extends undefined
    ? undefined
    : T extends null
    ? null
...
export type ObjectToPascal<T extends object | Date | undefined | null> =
  T extends undefined
    ? undefined
    : T extends null
    ? null
...
export type ObjectToSnake<T extends object | Date | undefined | null> =
  T extends undefined
    ? undefined
    : T extends null
    ? null
